...
const quiltArray = [
   ...
   {title: "Name",
    thumbnail: "",
    url: "https://www.etsy.com/listing/1799142679/6-sizes-ombre-mountains-quilt-pattern?ref=collection_page",
    category: "Paid"},
   {title: "Name",
    thumbnail: "",
    url: "https://quiltingbookspatternsandnotions.com/products/1108-downloadable-fishscape?variant=41932043452439",
    category: "Paid"},
   {title: "Name",
...
quiltArray.forEach(quiltPattern => { // This loops through the array and is a function
  if (quiltPattern.category === "Owned" && quiltPattern.thumbnail !== "") {
    let html =
    `<div class="pattern">
  ...
  } else if (quiltPattern.category === "Owned" && quiltPattern.thumbnail === "") {
    let html =
    `<div class="pattern">
...
quiltArray.forEach(quiltPattern => {
  ...
  } else if (quiltPattern.category === "No Pattern" && quiltPattern.thumbnail === "") {
    let html =
    `<div class="pattern">
       <div class="placeholder">No Image Yet</div>
       <p class="pattern-link">${quiltPattern.title}</p>
